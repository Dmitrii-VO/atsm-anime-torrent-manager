...
Делать сразу после AniLibria и на её данных. Отдельно от многовариантного источника —
работа вхолостую.

## Приоритет 3 — поиск по названию (ТЗ §3, способ 2)

Опирается на тот же эндпоинт поиска AniLibria.
